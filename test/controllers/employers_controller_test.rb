...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { address: @employer.address, name: @employer.name, phone: @employer.phone, website: @employer.website }
    end
  ...
  test "should update employer" do
    patch :update, id: @employer, employer: { address: @employer.address, name: @employer.name, phone: @employer.phone, website: @employer.website }
    assert_redirected_to employer_path(assigns(:employer))
  end
